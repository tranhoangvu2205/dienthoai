...
public class ConnectionDB {
    ...
    public ConnectionDB()
    {
        try {
			...
			String connectionUrl=
					"jdbc:sqlserver://TRANTHUY:1433;databaseName=DBQuanLyBanHang;encrypt=false;";
    ...
    public boolean themTaiKhoan(String maTK, String tenDN, String matKhau, String hoTen, String soDT, String diaChi, String ngaySinh, String quyen){
        try{
...
"          )";
    ...
    public boolean themPhieuNhap(String ma){
        try{
