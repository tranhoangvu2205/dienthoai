...
public class FormNhaCC extends javax.swing.JFrame {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (ma.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Mã NCC không để trống");
            return;
        }
        String ten=txtTenNCC.getText();
        if (ten.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Tên NCC không để trống");
            return;
        }
        String sdt=txtSDT.getText();
        if (sdt.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Số dt không để trống");
            return;
        }
        String dc=txtDiachi.getText();
        if (dc.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Địa chỉ không để trống");
            return;
        }
